...
<body>
    ...
    <!-- -- -- - -- -- -- - -- -- -- - -- -- -- -- -
               TOPBAR START
               -- -- -- - -- -- -- - -- -- -- - -- -- -- -- -->
               @if($vtour->nama_tempat == 1)

<div align="center" style="height: 100%; overflow:hidden;">
    <noscript>
        <div style="color: red; width: 30%; border: 1px solid red; padding: 4px; font-family: sans-serif;">ERROR: Your web browser must have JavaScript enabled to show this panorama.</div>
    </noscript>
    <div id="panoStudioViewerID" style="position: absolute; left: 0px; top: 0px; width: 100% ; height: 100% ;"></div>
    <script type="text/javascript" src="{{url('public')}}/panorama/panoStudioViewer.js"></script>
    <script type="text/javascript">
        panoStudioViewer.insert("panoStudioViewerID", "{{url('public')}}/panorama/depankeraton.js", {
...
@endif
@if($vtour->nama_tempat == 2)
<div align="center" style="height: 100%; overflow:hidden;">
    <noscript>
        <div style="color: red; width: 30%; border: 1px solid red; padding: 4px; font-family: sans-serif;">ERROR: Your web browser must have JavaScript enabled to show this panorama.</div>
    </noscript>
    <div id="panoStudioViewerID" style="position: absolute; left: 0px; top: 0px; width: 100% ; height: 100% ;"></div>
    <script type="text/javascript" src="{{url('public')}}/makam/panoStudioViewer.js"></script>
    <script type="text/javascript">
        panoStudioViewer.insert("panoStudioViewerID", "{{url('public')}}/makam/gerbangutama.js", {
            html5: "viewport_fit_cover|disable_webgl_warning"
        });
    </script>
</div>
