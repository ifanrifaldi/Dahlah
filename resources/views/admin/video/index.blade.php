                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="{{ url("admin/video/$video->id") }}" class="btn btn-primary"><span class="fa fa-info"></span> </a>
                                ...
                                <!-- <td class="text-center"><iframe src ="https://www.youtube.com/embed/{{ $video->link }}" style="height: 150px; width:150px;"> </iframe></td>                                 -->
